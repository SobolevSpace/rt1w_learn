...
public:
    ...
    bvh_node(std::vector<shared_ptr<hittable>>& h_list, size_t start,
...
bool bvh_node::hit(const ray& r, double t_min, double t_max, hit_record& rec) const {
    if (!box.hit(r, t_min, t_max, rec)) return false;
...
bvh_node::bvh_node(std::vector<shared_ptr<hittable>>& h_list, size_t start, 
size_t end, double t0, double t1) {
